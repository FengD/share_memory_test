...
typedef struct {
  real_T CANUnpack_o1;                 /* '<S26>/CAN Unpack' */
  real_T CANUnpack_o2;                 /* '<S26>/CAN Unpack' */
  real_T CANUnpack_o3;                 /* '<S26>/CAN Unpack' */
  real_T L3_Location;                  /* '<S26>/L3_Location' */
  real_T L3_MarkType;                  /* '<S26>/L3_MarkType' */
  real_T L3_Quality;                   /* '<S26>/L3_Quality' */
} rtB_CAN_659_dbcpack;

/* Block states (auto storage) for system '<Root>/CAN_659' */
typedef struct {
  int_T CANUnpack_ModeSignalID;        /* '<S26>/CAN Unpack' */
  int_T CANUnpack_StatusPortID;        /* '<S26>/CAN Unpack' */
